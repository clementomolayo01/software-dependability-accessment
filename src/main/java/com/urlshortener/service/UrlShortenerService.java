...
public class UrlShortenerService {
    ...
    public String shortenUrl(String originalUrl, String username) {
        ...
        // @ assume shortCode != null && !shortCode.isEmpty();
        return shortCode;
    }
     ...
     */
    // @ requires url != null;
    // @ ensures \result == (url.startsWith("http://") ||
